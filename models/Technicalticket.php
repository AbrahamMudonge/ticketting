...
/**
 * This is the model class for table "technicalticket".
 *
 * @property string $dateCreated
 * @property string $dateToday
 * @property int $technicalticketID
 * @property int $id
 ...
 */
class Technicalticket extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['dateCreated'], 'safe'],
            [['id', 'sourceID', 'clientID', 'FullDetails', 'dateToday'], 'required'],
